...
public static class HostBuilderExtensions
{
        ...
        Action<FlexConfigurationBuilder>? configure = null)
    {
        ...
        return hostBuilder
            ...
            .ConfigureContainer<ContainerBuilder>((context, containerBuilder) => ConfigureContainer(configure, containerBuilder, context));
    }
    ...
    /// </param>
    /// <param name="context">
    /// The host builder context containing the existing configuration and environment information.
    ...
    /// </para>
    /// </remarks>
    private static void ConfigureContainer(Action<FlexConfigurationBuilder>? configure, ContainerBuilder containerBuilder, HostBuilderContext context)
    {
        ...
        containerBuilder.AddFlexConfig(config =>
        {
            ...
            config.UseExistingConfiguration(context.Configuration);
        ...
        containerBuilder.AddModules(context.Configuration);
    }
}
